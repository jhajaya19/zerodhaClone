        ...
        <div className='container'>
            <div className='row p-5 mb-5 mt-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-5'>
                    ...
                    <a href=''style={{textDecoration: "none" , lineHeight: "2.5"}}>Zerodha IFC FIRST Bank 3-in-1</a><br/>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href=''style={{textDecoration: "none" , lineHeight: "2.5"}}>Stock reports</a><br/>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-4'><i class="fa fa-circle-o" aria-hidden="true"></i> Coin</h4>
