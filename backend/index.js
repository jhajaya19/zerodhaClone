...
app.use(cors({
  origin: ['https://zerodha-ft.netlify.app', "https://zerodhaclone-bd.onrender.com/verify", "https://zerodha-db.netlify.app"], // Allow all origins (you can restrict this to specific domains in production)
